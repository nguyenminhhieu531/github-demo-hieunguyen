  ...
  <div class="tieude">Chi tiết sản phẩm</div>
          ...
          $dong_thongtinsp=mysql_fetch_array($sql_thongtinsp);
                        ...
                        <div id="panel1" class="panel active">
                          <p><iframe width="560" height="315" src="https://www.youtube.com/embed/oKRjsZE-bro" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>
                        </div>
                   <?php
          }else{
